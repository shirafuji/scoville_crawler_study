...
ここで`.on_pages_like(正規表現) do |page|`を使うと、その正規表現に合ったurlのページのみをクロールする
___
```
...
今回は、先ほどcreateしたArticle1つ1つに記事のカテゴリーの情報を入れるcrawlerを作ります。  
自分で中身を書いてみましょう！
___
## 6. 今後のために
___
...
___
### 応用
前で紹介したオプションやメソッドを利用して、複数ページを回るcrawlerをなるべく無駄なく実装する
